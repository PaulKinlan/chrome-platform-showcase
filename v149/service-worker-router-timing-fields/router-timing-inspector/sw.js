      ...
      await self.registration.addRoutes([
        {
          condition: {
            urlPattern: new URLPattern({
              pathname:
                "/v149/service-worker-router-timing-fields/router-timing-inspector/assets/cached-*",
            }),
          },
          source: "cache",
        },
        {
          condition: {
            urlPattern: new URLPattern({
              pathname:
                "/v149/service-worker-router-timing-fields/router-timing-inspector/assets/network-*",
            }),
          },
          source: "network",
        },
        {
          condition: {
            urlPattern: new URLPattern({
              pathname:
                "/v149/service-worker-router-timing-fields/router-timing-inspector/assets/sw-*",
            }),
          },
          source: "fetch-event",
        },
